...
class InvoiceCollection(Invoice):
    ...
    def set_daten(self, daten: ExcelContent = None) -> None:
        if daten is not None:
            ...
            # Kundennummer auslesen - immer in der gleichen Spalte wie Rechnungsnummer
            # suche nach "Kunden-Nr:" und hole den Wert rechts davon
            self.customer_number = daten.get_customer_number(
                spalte=spalte, zeile=None
            )
            spalte = (
