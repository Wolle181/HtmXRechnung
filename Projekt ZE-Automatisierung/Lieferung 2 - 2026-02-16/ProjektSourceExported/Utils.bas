...
Public Function FindHeaderCol(ws As Worksheet, hdrRow As Long, headerText As String) As Long
    ...
    For c = 1 To lastCol
        cellValue = CStr(ws.Cells(hdrRow, c).Value2)
    ...
    MsgBox "PROBLEM: FindHeaderCol kann Spalte '" & headerText & "' nicht finden." & vbCrLf & "Ursache finden, sonst werden Daten nicht gelesen."
